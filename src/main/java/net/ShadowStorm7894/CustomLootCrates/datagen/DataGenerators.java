...
@Mod.EventBusSubscriber(modid = CustomLootCrates.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event){
        ...
        generator.addProvider(event.includeClient(), new ModEn_UsLang(packOutput, "en_us"));
